...
export const IssueIcon = ({ className }: IconProps) => (
  <svg
    ...
    height="18"
    fill="currentColor"
    className={`bi bi-info-lg  ${className}`}
    viewBox="0 0 16 16"
  >
...
export const DeleteIcon = ({ className }: IconProps) => (
  <svg
    ...
    height="20"
    fill="currentColor"
    className={`bi bi-trash3 fill-red-500 ${className}`}
    viewBox="0 0 16 16"
  >
...
export const FilterIcon = ({ className }: IconProps) => (
  <svg
    className={`w-5 h-5 mr-2 inline ${className}`}
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
  >
...
export const BuildingIcon = ({ className }: IconProps) => (
  <svg
    ...
    height="14"
    fill="currentColor"
    className={`bi bi-building  ${className}`}
    viewBox="0 0 16 16"
  >
...
export const LocationIcon = ({ className }: IconProps) => (
  <svg
    ...
    height="14"
    fill="currentColor"
    className={`bi bi-geo-alt  ${className}`}
    viewBox="0 0 16 16"
  >
...
export const PublicRepoIcon = ({ className }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="14"
    height="14"
    fill="currentColor"
    className={`bi bi-book-half  ${className}`}
    viewBox="0 0 16 16"
  >
...
export const PrivateRepoIcon = ({ className }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="14"
    height="14"
...
export const ArrowDownIcon = ({ className }: IconProps) => (
  <svg
    ...
    height="14"
    fill="currentColor"
    className={`bi bi-arrow-down ${className}`}
    viewBox="0 0 16 16"
  >
    <path
      fillRule="evenodd"
