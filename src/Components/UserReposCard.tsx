...
const UserRepoCard: React.FC<UserRepoCardProps> = memo(({ repo }) => {
  ...
  return (
    <div className="border border-gray/30 rounded-lg p-2 md:p-5 hover:border-secondary transition-colors duration-200 group backdrop-blur md:backdrop-blur-xl">
